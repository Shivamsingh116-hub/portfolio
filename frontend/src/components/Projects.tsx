...
const Projects = () => {
    return (
        <>
            <div className='sticky top-0 z-20 px-6 py-5 -mx-6 mb-4 backdrop-blur-md bg-[var(--default-bg)] w-screen lg:sr-only'>
                <h2
            ...
            <div>
                <p className='mb-4'> I’m a developer passionate about building scalable and secure full-stack web applications that
